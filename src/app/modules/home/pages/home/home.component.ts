...
export class HomeComponent {
  ...
  // Projects
  project1 = new Card($localize `Rock Paper Scissors`, $localize `Small project for PMDM`, 'assets/images/projects/rock-paper-scissors/proj-pic.webp', 'projects/rps-game')
  project2 = new Card($localize `Slot-machine`, $localize `Small project for PMDM`, 'assets/images/projects/slot-machine/proj-pic.webp', 'projects/slot-game')
  project3 = new Card($localize `Project 3`, $localize `Example description project 3`, 'assets/images/projects/rock-paper-scissors/proj-pic.webp', 'projects/rps-game')
