...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'rps-game',
        loadChildren: () => import('@modules-ext/rock-paper-scissors-game/rock-paper-scissors-game.module').then((m):typeof RockPaperScissorsGameModule => m.RockPaperScissorsGameModule),
      },
      {
        path: 'slot-game',
