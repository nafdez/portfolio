...
export class RpsGameComponent {
  rpsImages: string[] = [
    "assets/images/projects/rock-paper-scissors/rock.webp",
    "assets/images/projects/rock-paper-scissors/paper.webp",
    "assets/images/projects/rock-paper-scissors/scissors.webp",
  ];
  ...
  userPick(pick: number) {
    ...
    let aiHTMLPic: HTMLElement = document.getElementById(
      "pickAi"
    ) as HTMLElement;
    this.animatePick(aiHTMLPic);
    let userHTMLPic: HTMLElement = document.getElementById(
      "pickU"
    ) as HTMLElement;
